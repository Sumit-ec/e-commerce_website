  ...
  return (
    <div className="container py-5">
      <div className="d-flex justify-content-between align-items-center flex-wrap sub-head-style">
        <h2
          className="mb-0 name-header"
          style={{ paddingLeft: "20px", paddingTop: "10px" }}
        >
          Wishlist (4)
        </h2>
        <button className="mt-3 mt-md-0 rounded ms-3 wishlist-button">
          Move All To Bag
        </button>
      </div>
      ...
      <div className="row g-4">
        ...
        <div className="col-md-3 padding-card">
          <div className="product-card position-relative">
            ...
            >
              ...
              <button
                className="btn btn-dark btn-sm position-absolute w-100 start-50 translate-middle-x d-flex justify-content-center align-items-center gap-2"
                style={{
                  bottom: "10px",
                  left: "50%",
        ...
        <div className="col-md-3 padding-card">
          <div className="product-card position-relative">
            ...
            <p className="text-danger fw-bold mb-1">$1960</p>
          </div>
        </div>
        ...
        <div className="col-md-3 padding-card">
          <div className="product-card position-relative">
            ...
            <p className="text-danger fw-bold mb-1">$550</p>
          </div>
        </div>
        ...
        <div className="col-md-3 padding-card">
          <div className="product-card position-relative">
            ...
            <p className="text-danger fw-bold mb-1">$750</p>
          </div>
        </div>
        ...
        <div className="d-flex justify-content-between align-items-center flex-wrap head-style">
          <div className="d-flex align-items-center">
            ...
            <div>
              <p className="header-text mb-0">Just For You</p>
            </div>
          </div>
          <button className="btn btn-danger mt-3 mt-md-0 rounded ms-3 ">
            See All
          </button>
        </div>
